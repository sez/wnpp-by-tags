...
""")
        ...
        self.assertEqual(pc.inst_of_pkg("a2ps"), 5696)
        self.assertEqual(pc.inst_of_pkg("abcm2ps"), 114)
        self.assertEqual(pc.inst_of_pkg("acheck"), 59)
        self.assertEqual(pc.inst_of_pkg("acheck-rules"), 46)
        self.assertEqual(pc.inst_of_pkg("easydiff.app"), 128)
